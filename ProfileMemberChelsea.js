...
// layar home
const ProfileMemberChelsea = ({ navigation }) => {
    return (
                ...
                <View style={{flex: 1, alignItems: "center", justifyContent: "center"}}>
                    ...
                    <View style={{backgroundColor:'#8BCFFF', width:350, height: 640, flexDirection:'column', borderRadius:16}}>
                        ...
                        <View style={{flex:2, flexDirection:'coloumn', justifyContent:'flex-start', marginLeft:20}}>
                            ...
                            <Text style={{backgroundColor:'#FEFBFB', width:300, height:35, padding:5, borderRadius:10, color:'#303030'}}>Chelsea Ramadhani</Text>
                        </View>

                        <View style={{flex:2, flexDirection:'coloumn', justifyContent:'flex-start', marginLeft:20}}>
                            <Text style={{color:'#FEFBFB', fontWeight:'bold', fontSize:16, marginBottom:8}}>Birth Date : </Text>
                            <Text style={{backgroundColor:'#FEFBFB', width:300, height:35, padding:5, borderRadius:10, color:'#303030'}}>October 19th 2006</Text>
                        </View>

                        <View style={{flex:2, flexDirection:'coloumn', justifyContent:'flex-start', marginLeft:20}}>
                            <Text style={{color:'#FEFBFB', fontWeight:'bold', fontSize:16, marginBottom:8}}>Instagram : </Text>
                            <Text style={{backgroundColor:'#FEFBFB', width:300, height:35, padding:5, borderRadius:10, color:'#303030'}}>@chellsea_aa</Text>
                        </View>
                        ...
                        <View style={{flex:4, flexDirection:'coloumn', justifyContent:'flex-start', marginLeft:20}}>
                            ...
                            <Text style={{backgroundColor:'#FEFBFB', width:300, height:100, padding:5, borderRadius:10, color:'#303030'}}>Listening to music, Watching movies/kdrama</Text>
                        </View>
...
export default ProfileMemberChelsea;
